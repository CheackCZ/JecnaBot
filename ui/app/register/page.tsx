  ...
  return (
    <div className="flex flex-row items-center justify-center min-h-screen bg-[#09090B]">
      ...
      <div className="w-[50%] h-screen flex flex-col items-center justify-center pe-[10%]">
        <h1 className="text-3xl font-semibold text-center mt-6 mb-6">Welcome to JečnáBot!</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4 w-[60%]">
          ...
          <div className="grid w-full gap-1.5">
            ...
            <textarea className="w-full text-white bg-[#09090B] border border-[#27272A] placeholder-[#27272A] hover:border-white focus:border-white focus:ring focus:ring-[#09090B] rounded" placeholder="Type your message here." id="message" />
          </div>
